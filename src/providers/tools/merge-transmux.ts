...
export type MergeTransmuxEventMap = {
  ['increase progress'](value: number): void
  ['increase total'](value: number): void
}

export class MergeTransmux extends AbstractExecutor {
  private _events = new EventEmitter() as TypeNodeJSEventEmitter<MergeTransmuxEventMap>
  ...
  get events(): TypedEventEmitterListener<MergeTransmuxEventMap> {
    return this._events
  }
